...
public class WordAdapter extends ArrayAdapter<Word> {
    ...
    //Resource ID for background color to the list of words
    private int mColorResourceId;
    /**
     * This is our my custom constructor (it doesn't mirror a superclass constructor).
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView turkishTextView = (TextView) listItemView.findViewById(R.id.turkish_text_view);
